...
<div class="container content">
	...
	<div class="row">
		<div class="large-6 column">
			<?php $this->renderPartial('_patient_details', array('contact'=>$contact))?>
			<?php $this->renderPartial('_patient_contact_details', array('contact'=>$contact))?>
			<?php $this->renderPartial('_patient_gp', array('gp'=>$gp,'practice'=>$practice))?>
