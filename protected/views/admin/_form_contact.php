...
<?php
$contact_label_id = CHtml::listData(ContactLabel::model()->findAll(array('order' => 'name')), 'id', 'name');
?>
<?php
...
<?php echo $form->dropDownList($contact, 'contact_label_id', $contact_label_id, array('prompt' => '- None -')); ?>
