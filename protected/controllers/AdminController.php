    ...
    if (!empty($_POST)) {
      ...
      if (!$contact->validate()) {
        ...
        Audit::add('admin-Contact','edit',serialize(array_merge(array('id'=>@$_GET['contact_id']),$_POST)));
                ...
                if (!empty($patient)) {
                    $this->redirect(array('patient/view', 'id' => $patient->id));
                } else {
  ...
  public function actionInstitutions($id=false)
  {
    ...
    public function actionAddInstitution()
    {
        ...
        if (!empty($_POST)) {
            ...
            if (empty($errors)) {
                ...
                $institution->contact->setScenario('empty');
    ...
    public function actionEditInstitution()
    {
        ...
        if (!empty($_POST)) {
            /** @var $institution Institution */
            $institution->attributes = $_POST['Institution'];
            if (isset($_POST['Institution']['remote_id'])) {
                $institution->remote_id = (int)$_POST['Institution']['remote_id'];
            }
  ...
  public function actionSites($id=false)
  {
    ...
    public function actionAddSite()
    {
        ...
        if (!empty($_POST)) {
            ...
            $address->attributes = $_POST['Address'];
            $address->contact_id = $_POST['Site']['contact_id'];
            ...
            if (empty($errors)) {
                ...
                Audit::add('admin-Site', 'add', serialize(array_merge(array('id' => $site->id), $_POST)));
